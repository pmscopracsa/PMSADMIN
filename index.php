...
if(@$_SESSION['id'] && !isset($_COOKIE['cpmsRemember']) && !$_SESSION['rememberMe'])
{
...
if(@$_POST['submit']=='Login')
{
	...
	//{
		...
		//$row = mysql_fetch_assoc(mysql_query("SELECT id,usr FROM tb_empresa WHERE usr='{$_POST['username']}' AND pass='".md5($_POST['password'])."'"));
                $row = mysql_fetch_assoc(mysql_query("SELECT id,nombres,apellidos,nombre_usuario, estado, rol FROM tb_usuarioscpms WHERE nombre_usuario='$nombre_usuario' AND password='$password'"));
		...
		else $err[]='¡Nombre o contraseña incorrecto!';
	//}
...
<title>ADMINISTRACION CONTROL PMS</title>
    
    <link rel="stylesheet" type="text/css" href="CSS/index.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="CSS/login_panel/css/slide.css" media="screen" />
...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
    ...
    <script src="CSS/login_panel/js/slide.js" type="text/javascript"></script>
			...
			<div class="left">
				...
				<form class="clearfix" action="" method="post">
					...
					<input class="field" type="password" name="password" id="password" size="23" />
                                        ...
                                        <label><a href="managerhelp/managerhelp.php?oxr=password">¿Ha olvidado su contraseña?</a></label>
...
<div class="pageContent">
    <div id="main">
      <div class="container">
        <h1>ADMINISTRACION Control PMS</h1>
        <h2>Sistema de Gesti&oacute;n de Proyectos</h2>
        </div>
        
        <div class="container">
        
            >><a href="control/usersadmin.php">Administrador</a><br />
            >><a href="control/usersvisor.php">Supervisor</a><br />
